...
impl<'src> InterfaceTypeDefinition<'src> {
    /// Returns the name of this interface type definition as a string
    /// slice.
    ///
...
impl AstNode for InterfaceTypeDefinition<'_> {
    ...
    /// Returns this interface type definition's byte-offset span within the
    /// source text.
    ///
    ...
    /// Resolves this interface type definition's position to line/column
