...
impl<'src> ScalarTypeDefinition<'src> {
    /// Returns the name of this scalar type definition as a string
    /// slice.
    ///
...
impl AstNode for ScalarTypeDefinition<'_> {
    ...
    /// Returns this scalar type definition's byte-offset span within the
    /// source text.
    ///
    ...
    /// Resolves this scalar type definition's position to line/column
