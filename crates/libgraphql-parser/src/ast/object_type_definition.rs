...
impl<'src> ObjectTypeDefinition<'src> {
    /// Returns the name of this object type definition as a string
    /// slice.
    ///
...
impl AstNode for ObjectTypeDefinition<'_> {
    ...
    /// Returns this object type definition's byte-offset span within the
    /// source text.
    ///
    ...
    /// Resolves this object type definition's position to line/column
